...
To run all golang tests, open a new terminal in the repository root, then run the following command:
...
Once, your are inside the bridge folder, you can use the following command to run smart contracts tests:
