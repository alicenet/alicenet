...
type MockITask struct {
	...
	// GetEthFunc is an instance of a mock function object controlling the
	// behavior of the method GetEth.
	GetEthFunc *ITaskGetEthFunc
...
func NewMockITask() *MockITask {
	return &MockITask{
		...
		ExecuteFunc: &ITaskExecuteFunc{
			defaultHook: func() ([]*types.Transaction, error) {
				return nil, nil
			},
		},
		FinishFunc: &ITaskFinishFunc{
...
func NewStrictMockITask() *MockITask {
	return &MockITask{
		...
		GetEthFunc: &ITaskGetEthFunc{
			defaultHook: func() ethereum.Network {
				panic("unexpected invocation of MockITask.GetEth")
			},
		},
		GetIdFunc: &ITaskGetIdFunc{
			defaultHook: func() string {
...
type ITaskExecuteFunc struct {
	defaultHook func() ([]*types.Transaction, error)
	hooks       []func() ([]*types.Transaction, error)
...
func (f *ITaskExecuteFunc) SetDefaultHook(hook func() ([]*types.Transaction, error)) {
	f.defaultHook = hook
}
...
// front of the queue and discards it. After the queue is empty, the default
// hook function is invoked for any future action.
func (f *ITaskExecuteFunc) PushHook(hook func() ([]*types.Transaction, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *ITaskExecuteFunc) SetDefaultReturn(r0 []*types.Transaction, r1 error) {
	f.SetDefaultHook(func() ([]*types.Transaction, error) {
		return r0, r1
	})
}

// PushReturn calls PushHook with a function that returns the given values.
func (f *ITaskExecuteFunc) PushReturn(r0 []*types.Transaction, r1 error) {
	f.PushHook(func() ([]*types.Transaction, error) {
		return r0, r1
	})
}

func (f *ITaskExecuteFunc) nextHook() func() ([]*types.Transaction, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// ITaskGetEthFunc describes the behavior when the GetEth method of the
// parent MockITask instance is invoked.
type ITaskGetEthFunc struct {
	defaultHook func() ethereum.Network
	hooks       []func() ethereum.Network
	history     []ITaskGetEthFuncCall
	mutex       sync.Mutex
}
...
// SetDefaultHook sets function that is called when the GetEth method of the
// parent MockITask instance is invoked and the hook queue is empty.
func (f *ITaskGetEthFunc) SetDefaultHook(hook func() ethereum.Network) {
	f.defaultHook = hook
}

// PushHook adds a function to the end of hook queue. Each invocation of the
// GetEth method of the parent MockITask instance invokes the hook at the
// front of the queue and discards it. After the queue is empty, the default
// hook function is invoked for any future action.
func (f *ITaskGetEthFunc) PushHook(hook func() ethereum.Network) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *ITaskGetEthFunc) SetDefaultReturn(r0 ethereum.Network) {
...
// PushReturn calls PushHook with a function that returns the given values.
func (f *ITaskGetEthFunc) PushReturn(r0 ethereum.Network) {
	f.PushHook(func() ethereum.Network {
		return r0
	})
}

func (f *ITaskGetEthFunc) nextHook() func() ethereum.Network {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
func (f *ITaskGetEthFunc) appendCall(r0 ITaskGetEthFuncCall) {
	f.mutex.Lock()
	f.history = append(f.history, r0)
	f.mutex.Unlock()
}

// History returns a sequence of ITaskGetEthFuncCall objects describing the
// invocations of this function.
func (f *ITaskGetEthFunc) History() []ITaskGetEthFuncCall {
	f.mutex.Lock()
	history := make([]ITaskGetEthFuncCall, len(f.history))
	copy(history, f.history)
	f.mutex.Unlock()
...
// ITaskGetEthFuncCall is an object that describes an invocation of method
// GetEth on an instance of MockITask.
type ITaskGetEthFuncCall struct {
	// Result0 is the value of the 1st result returned from this method
	// invocation.
...
// Args returns an interface slice containing the arguments of this
// invocation.
func (c ITaskGetEthFuncCall) Args() []interface{} {
	return []interface{}{}
}

// Results returns an interface slice containing the results of this
// invocation.
func (c ITaskGetEthFuncCall) Results() []interface{} {
	return []interface{}{c.Result0}
}
...
// the parent MockITask instance is invoked and the hook queue is empty.
func (f *ITaskPrepareFunc) SetDefaultHook(hook func() error) {
	f.defaultHook = hook
}
...
// front of the queue and discards it. After the queue is empty, the default
// hook function is invoked for any future action.
func (f *ITaskPrepareFunc) PushHook(hook func() error) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *ITaskPrepareFunc) SetDefaultReturn(r0 error) {
	f.SetDefaultHook(func() error {
		return r0
	})
}
...
// PushReturn calls PushHook with a function that returns the given values.
func (f *ITaskPrepareFunc) PushReturn(r0 error) {
	f.PushHook(func() error {
		return r0
	})
}

func (f *ITaskPrepareFunc) nextHook() func() error {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
func (f *ITaskShouldExecuteFunc) SetDefaultHook(hook func() bool) {
	f.defaultHook = hook
}
...
// the front of the queue and discards it. After the queue is empty, the
// default hook function is invoked for any future action.
func (f *ITaskShouldExecuteFunc) PushHook(hook func() bool) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *ITaskShouldExecuteFunc) SetDefaultReturn(r0 bool) {
	f.SetDefaultHook(func() bool {
		return r0
	})
}
...
// PushReturn calls PushHook with a function that returns the given values.
func (f *ITaskShouldExecuteFunc) PushReturn(r0 bool) {
	f.PushHook(func() bool {
		return r0
	})
}

func (f *ITaskShouldExecuteFunc) nextHook() func() bool {
	f.mutex.Lock()
	defer f.mutex.Unlock()
