...
func NewMockContracts() *MockContracts {
	return &MockContracts{
		...
		LookupContractsFunc: &ContractsLookupContractsFunc{
			defaultHook: func(context.Context, common.Address) (r0 error) {
				return
			},
		},
		PublicStakingFunc: &ContractsPublicStakingFunc{
...
func NewMockGethClient() *MockGethClient {
	return &MockGethClient{
		BalanceAtFunc: &GethClientBalanceAtFunc{
			defaultHook: func(context.Context, common.Address, *big.Int) (r0 *big.Int, r1 error) {
				return
			},
		},
		BlockByHashFunc: &GethClientBlockByHashFunc{
			defaultHook: func(context.Context, common.Hash) (r0 *types.Block, r1 error) {
				return
			},
		},
		BlockByNumberFunc: &GethClientBlockByNumberFunc{
		...
		CallContractFunc: &GethClientCallContractFunc{
			defaultHook: func(context.Context, goethereum.CallMsg, *big.Int) (r0 []byte, r1 error) {
				return
			},
		},
		CodeAtFunc: &GethClientCodeAtFunc{
			defaultHook: func(context.Context, common.Address, *big.Int) (r0 []byte, r1 error) {
				return
			},
		},
		EstimateGasFunc: &GethClientEstimateGasFunc{
			defaultHook: func(context.Context, goethereum.CallMsg) (r0 uint64, r1 error) {
				return
			},
		},
		FilterLogsFunc: &GethClientFilterLogsFunc{
			defaultHook: func(context.Context, goethereum.FilterQuery) (r0 []types.Log, r1 error) {
				return
			},
		},
		HeaderByHashFunc: &GethClientHeaderByHashFunc{
			defaultHook: func(context.Context, common.Hash) (r0 *types.Header, r1 error) {
				return
			},
		},
		HeaderByNumberFunc: &GethClientHeaderByNumberFunc{
		...
		NonceAtFunc: &GethClientNonceAtFunc{
			defaultHook: func(context.Context, common.Address, *big.Int) (r0 uint64, r1 error) {
				return
			},
		},
		PendingCodeAtFunc: &GethClientPendingCodeAtFunc{
			defaultHook: func(context.Context, common.Address) (r0 []byte, r1 error) {
				return
			},
		},
		PendingNonceAtFunc: &GethClientPendingNonceAtFunc{
		...
		StorageAtFunc: &GethClientStorageAtFunc{
			defaultHook: func(context.Context, common.Address, common.Hash, *big.Int) (r0 []byte, r1 error) {
				return
			},
		},
		SubscribeFilterLogsFunc: &GethClientSubscribeFilterLogsFunc{
			defaultHook: func(context.Context, goethereum.FilterQuery, chan<- types.Log) (r0 goethereum.Subscription, r1 error) {
				return
			},
		},
		SubscribeNewHeadFunc: &GethClientSubscribeNewHeadFunc{
			defaultHook: func(context.Context, chan<- *types.Header) (r0 goethereum.Subscription, r1 error) {
				return
			},
		},
		SuggestGasPriceFunc: &GethClientSuggestGasPriceFunc{
			defaultHook: func(context.Context) (r0 *big.Int, r1 error) {
				return
			},
		},
		SuggestGasTipCapFunc: &GethClientSuggestGasTipCapFunc{
		...
		TransactionCountFunc: &GethClientTransactionCountFunc{
			defaultHook: func(context.Context, common.Hash) (r0 uint, r1 error) {
				return
			},
		},
		TransactionInBlockFunc: &GethClientTransactionInBlockFunc{
			defaultHook: func(context.Context, common.Hash, uint) (r0 *types.Transaction, r1 error) {
				return
			},
		},
		TransactionReceiptFunc: &GethClientTransactionReceiptFunc{
...
func NewMockTask() *MockTask {
	return &MockTask{
		...
		DoRetryFunc: &TaskDoRetryFunc{
			defaultHook: func(context.Context, *logrus.Entry, interfaces.Ethereum) (r0 error) {
				return
			},
		},
		DoWorkFunc: &TaskDoWorkFunc{
		...
		InitializeFunc: &TaskInitializeFunc{
			defaultHook: func(context.Context, *logrus.Entry, interfaces.Ethereum, interface{}) (r0 error) {
				return
			},
		},
		ShouldRetryFunc: &TaskShouldRetryFunc{
			defaultHook: func(context.Context, *logrus.Entry, interfaces.Ethereum) (r0 bool) {
				return
			},
		},
	}
...
func NewMockTxnQueue() *MockTxnQueue {
	return &MockTxnQueue{
		...
		QueueAndWaitFunc: &TxnQueueQueueAndWaitFunc{
			defaultHook: func(context.Context, *types.Transaction) (r0 *types.Receipt, r1 error) {
				return
			},
		},
		QueueGroupTransactionFunc: &TxnQueueQueueGroupTransactionFunc{
		...
		WaitGroupTransactionsFunc: &TxnQueueWaitGroupTransactionsFunc{
			defaultHook: func(context.Context, int) (r0 []*types.Receipt, r1 error) {
				return
			},
		},
		WaitTransactionFunc: &TxnQueueWaitTransactionFunc{
