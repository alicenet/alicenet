...
//go:generate go-mockgen -f -i IETHDKG -i IGovernance -i IALCA -i IALCB -i IAliceNetFactory -i IPublicStaking -i ISnapshots -i IValidatorPool -i IValidatorStaking -i IDynamics -o bindings.mockgen.go ../../bridge/bindings/ethereum
