...
//go:generate go-mockgen -f -i Task -o ../../layer1/executor/tasks/mocks/interfaces_tasks.mockgen.go ../../layer1/executor/tasks
//go:generate go-mockgen -f -i TaskHandler -i TaskResponse -o ../../layer1/executor/mocks/interfaces_executor.mockgen.go ../../layer1/executor/
