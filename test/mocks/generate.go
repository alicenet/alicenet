...
//go:generate go-mockgen -f -i Contracts -i AdminHandler -i TxnQueue -i GethClient -i ITask -o interfaces.mockgen.go github.com/MadBase/MadNet/blockchain/interfaces
