...
//go:generate go-mockgen -f -i Contracts -i AdminHandler -i TxnQueue -i GethClient -i Task -o interfaces.mockgen.go github.com/MadBase/MadNet/blockchain/interfaces
