...
//go:generate go-mockgen -f -i Task -o interfaces_tasks.mockgen.go ../../layer1/executor/tasks
//go:generate go-mockgen -f -i TaskHandler -i TaskResponse -o interfaces_executor.mockgen.go ../../layer1/executor/
