...
var file_proto_aobjs_proto_rawDesc = []byte{
	...
	0x46, 0x65, 0x65, 0x22, 0x76, 0x0a, 0x05, 0x54, 0x58, 0x4f, 0x75, 0x74, 0x12, 0x33, 0x0a, 0x0a,
	...
	0x73, 0x75, 0x6d, 0x65, 0x64, 0x54, 0x78, 0x48, 0x61, 0x73, 0x68, 0x22, 0x57, 0x0a, 0x0a, 0x56,
...
var file_proto_aobjs_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_proto_aobjs_proto_goTypes = []interface{}{
	...
	(*ValueStore)(nil),   // 5: proto.ValueStore
	(*VSPreImage)(nil),   // 6: proto.VSPreImage
	(*DataStore)(nil),    // 7: proto.DataStore
	(*DSLinker)(nil),     // 8: proto.DSLinker
	(*DSPreImage)(nil),   // 9: proto.DSPreImage
}
var file_proto_aobjs_proto_depIdxs = []int32{
	2, // 0: proto.Tx.Vin:type_name -> proto.TXIn
	1, // 1: proto.Tx.Vout:type_name -> proto.TXOut
	5, // 2: proto.TXOut.ValueStore:type_name -> proto.ValueStore
	7, // 3: proto.TXOut.DataStore:type_name -> proto.DataStore
	3, // 4: proto.TXIn.TXInLinker:type_name -> proto.TXInLinker
	4, // 5: proto.TXInLinker.TXInPreImage:type_name -> proto.TXInPreImage
	6, // 6: proto.ValueStore.VSPreImage:type_name -> proto.VSPreImage
	8, // 7: proto.DataStore.DSLinker:type_name -> proto.DSLinker
	9, // 8: proto.DSLinker.DSPreImage:type_name -> proto.DSPreImage
