...
func Test_TaskExecutor_HappyPath(t *testing.T) {
	...
	executor.handleTaskExecution(task, "", "123", 1, 10, false, nil, db, nil, executor.logger, client, mocks.NewMockAllSmartContracts(), taskRespChan)
...
func Test_TaskExecutor_TaskInTasksExecutorTransactions(t *testing.T) {
	...
	executor.handleTaskExecution(task, "", taskId, 1, 10, false, nil, db, nil, executor.logger, client, mocks.NewMockAllSmartContracts(), taskRespChan)
