...
func TestDisputeMissingShareDistributionTask_Group_1_ShouldAccuseOneValidatorWhoDidNotDistributeShares(
	t *testing.T,
) {
	n := 5
	u := []int{4}
...
func TestDisputeMissingShareDistributionTask_Group_1_ShouldAccuseAllValidatorsWhoDidNotDistributeShares(
	t *testing.T,
) {
	n := 5
	u := []int{0, 1, 2, 3, 4}
...
func TestDisputeMissingShareDistributionTask_Group_1_ShouldNotAccuseValidatorsWhoDidDistributeShares(
	t *testing.T,
) {
	n := 5
	u := []int{}
