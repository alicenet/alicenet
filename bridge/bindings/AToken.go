...
func (_AToken *ATokenTransactor) Initialize(opts *bind.TransactOpts, initialMintAmount *big.Int) (*types.Transaction, error) {
	return _AToken.contract.Transact(opts, "initialize", initialMintAmount)
}

// Initialize is a paid mutator transaction binding the contract method 0xfe4b84df.
//
// Solidity: function initialize(uint256 initialMintAmount) returns()
func (_AToken *ATokenSession) Initialize(initialMintAmount *big.Int) (*types.Transaction, error) {
	return _AToken.Contract.Initialize(&_AToken.TransactOpts, initialMintAmount)
}

// Initialize is a paid mutator transaction binding the contract method 0xfe4b84df.
//
// Solidity: function initialize(uint256 initialMintAmount) returns()
func (_AToken *ATokenTransactorSession) Initialize(initialMintAmount *big.Int) (*types.Transaction, error) {
	return _AToken.Contract.Initialize(&_AToken.TransactOpts, initialMintAmount)
}
