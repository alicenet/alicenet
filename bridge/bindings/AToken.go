...
func (_AToken *ATokenTransactor) MigrateTo(opts *bind.TransactOpts, to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _AToken.contract.Transact(opts, "migrateTo", to, amount)
}

// MigrateTo is a paid mutator transaction binding the contract method 0x0d213d31.
//
// Solidity: function migrateTo(address to, uint256 amount) returns(uint256)
func (_AToken *ATokenSession) MigrateTo(to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _AToken.Contract.MigrateTo(&_AToken.TransactOpts, to, amount)
}

// MigrateTo is a paid mutator transaction binding the contract method 0x0d213d31.
//
// Solidity: function migrateTo(address to, uint256 amount) returns(uint256)
func (_AToken *ATokenTransactorSession) MigrateTo(to common.Address, amount *big.Int) (*types.Transaction, error) {
	return _AToken.Contract.MigrateTo(&_AToken.TransactOpts, to, amount)
}
