...
func (_AToken *ATokenCaller) GetArbitraryContractAddress(opts *bind.CallOpts, _salt [32]byte, _factory common.Address, byteCodeHash_ [32]byte) (common.Address, error) {
	var out []interface{}
	err := _AToken.contract.Call(opts, &out, "getArbitraryContractAddress", _salt, _factory, byteCodeHash_)
...
//
// Solidity: function getArbitraryContractAddress(bytes32 _salt, address _factory, bytes32 byteCodeHash_) pure returns(address)
func (_AToken *ATokenSession) GetArbitraryContractAddress(_salt [32]byte, _factory common.Address, byteCodeHash_ [32]byte) (common.Address, error) {
	return _AToken.Contract.GetArbitraryContractAddress(&_AToken.CallOpts, _salt, _factory, byteCodeHash_)
}

// GetArbitraryContractAddress is a free data retrieval call binding the contract method 0x3cd1efee.
//
// Solidity: function getArbitraryContractAddress(bytes32 _salt, address _factory, bytes32 byteCodeHash_) pure returns(address)
func (_AToken *ATokenCallerSession) GetArbitraryContractAddress(_salt [32]byte, _factory common.Address, byteCodeHash_ [32]byte) (common.Address, error) {
	return _AToken.Contract.GetArbitraryContractAddress(&_AToken.CallOpts, _salt, _factory, byteCodeHash_)
}
