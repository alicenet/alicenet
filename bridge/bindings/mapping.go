...
var FunctionMapping = map[[4]byte]string{
	...
	{83, 97, 204, 107}:   "Dynamics.setMinDataStoreFee(uint64)",
	{106, 202, 27, 58}:   "Dynamics.setMinMaxBlockSize(uint32)",
	{221, 201, 198, 22}:  "Dynamics.setMinMinScaledTransactionFee(uint128)",
	{81, 41, 191, 185}:   "Dynamics.setMinPreCommitTimeout(uint32)",
	{48, 215, 100, 154}:  "Dynamics.setMinPreVoteTimeout(uint32)",
	{251, 255, 160, 138}: "Dynamics.setMinProposalTimeout(uint24)",
	{71, 211, 253, 208}:  "Dynamics.setMinValueStoreFee(uint64)",
