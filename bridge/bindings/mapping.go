...
var FunctionMapping = map[[4]byte]string{
	...
	{161, 129, 30, 245}:  "ALCA.isEarlyStageMigration()",
	...
	{103, 251, 210, 137}: "ALCB.destroyTokens(uint256)",
	...
	{198, 124, 184, 209}: "ALCB.getEthFromTokensBurn(uint256,uint256,uint256)",
	{104, 135, 39, 197}:  "ALCB.getEthToMintTokens(uint256,uint256)",
	{229, 27, 85, 227}:   "ALCB.getLatestEthFromTokensBurn(uint256)",
	{241, 74, 40, 249}:   "ALCB.getLatestEthToMintTokens(uint256)",
	{70, 113, 23, 115}:   "ALCB.getLatestMintedTokensFromEth(uint256)",
	{8, 108, 254, 253}:   "ALCB.getMarketSpread()",
	{134, 83, 164, 101}:  "ALCB.getMetamorphicContractAddress(bytes32,address)",
	{103, 159, 116, 45}:  "ALCB.getMintedTokensFromEth(uint256,uint256)",
	{171, 215, 10, 162}:  "ALCB.getPoolBalance()",
	{141, 64, 120, 35}:   "ALCB.getTotalTokensDeposited()",
	...
	{220, 253, 164, 121}: "Dynamics.getAllDynamicValues()",
	{107, 213, 12, 239}:  "Dynamics.getConfiguration()",
	{73, 241, 63, 104}:   "Dynamics.getEncodingVersion()",
	{224, 165, 64, 137}:  "Dynamics.getFurthestDynamicValues()",
	...
	{176, 230, 168, 165}: "Dynamics.initialize(uint24)",
