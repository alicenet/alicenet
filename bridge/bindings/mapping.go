...
var FunctionMapping = map[[4]byte]string{
	...
	{94, 119, 57, 103}:   "AccusationMultipleProposal.isAccused(bytes32)",
	...
	{199, 214, 41, 132}:  "ValidatorPool.majorSlash(address,address,bytes32)",
	{81, 125, 59, 252}:   "ValidatorPool.minorSlash(address,address,bytes32)",
