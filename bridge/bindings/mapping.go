...
var FunctionMapping = map[[4]byte]string{
	...
	{15, 253, 122, 129}:  "AToken.getStaticPoolContractAddress(bytes32,address)",
	...
	{15, 253, 122, 129}:  "ATokenBurner.getStaticPoolContractAddress(bytes32,address)",
	{134, 83, 164, 101}:  "ATokenMinter.getMetamorphicContractAddress(bytes32,address)",
	{15, 253, 122, 129}:  "ATokenMinter.getStaticPoolContractAddress(bytes32,address)",
	...
	{15, 253, 122, 129}:  "AliceNetFactory.getStaticPoolContractAddress(bytes32,address)",
	...
	{196, 96, 42, 243}:   "BToken.depositTokensOnBridges(uint8,bytes)",
	{45, 198, 176, 36}:   "BToken.destroyBTokens(uint256)",
	{228, 252, 107, 109}: "BToken.distribute()",
	{255, 50, 254, 252}:  "BToken.getCentralBridgeRouterAddress()",
	...
	{15, 253, 122, 129}:  "Dynamics.getStaticPoolContractAddress(bytes32,address)",
	...
	{15, 253, 122, 129}:  "ETHDKG.getStaticPoolContractAddress(bytes32,address)",
	...
	{15, 253, 122, 129}:  "PublicStaking.getStaticPoolContractAddress(bytes32,address)",
	...
	{15, 253, 122, 129}:  "Snapshots.getStaticPoolContractAddress(bytes32,address)",
	...
	{15, 253, 122, 129}:  "ValidatorPool.getStaticPoolContractAddress(bytes32,address)",
	...
	{15, 253, 122, 129}:  "ValidatorStaking.getStaticPoolContractAddress(bytes32,address)",
