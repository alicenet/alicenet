...
var FunctionMapping = map[[4]byte]string{
	...
	{26, 17, 110, 39}:    "BToken.depositTokensOnBridges(uint256,uint256,uint16,bytes)",
	{45, 198, 176, 36}:   "BToken.destroyBTokens(uint256)",
	{223, 218, 38, 253}:  "BToken.destroyPreApprovedBTokens(address,uint256)",
	{228, 252, 107, 109}: "BToken.distribute()",
	{110, 153, 96, 195}:  "BToken.getAdmin()",
	{117, 208, 56, 17}:   "BToken.getCurrentEthFromBTokensBurn(uint256)",
	{29, 56, 153, 54}:    "BToken.getCurrentEthToMintBTokens(uint256)",
	{148, 177, 46, 200}:  "BToken.getCurrentMintedBTokensFromEth(uint256)",
