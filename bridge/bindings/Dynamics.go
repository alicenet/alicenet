...
type DynamicValues struct {
	...
	MessageTimeout          *big.Int
	ProposalTimeout         uint32
	PreVoteTimeout          uint32
	PreCommitTimeout        uint32
	MaxBlockSize            uint64
	AtomicSwapFee           uint64
	DataStoreFee            uint64
