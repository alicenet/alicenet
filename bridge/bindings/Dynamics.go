...
func (_Dynamics *DynamicsTransactor) SetMinDataStoreFee(opts *bind.TransactOpts, minDataStoreFee_ uint64) (*types.Transaction, error) {
	return _Dynamics.contract.Transact(opts, "setMinDataStoreFee", minDataStoreFee_)
}

// SetMinDataStoreFee is a paid mutator transaction binding the contract method 0x5361cc6b.
//
// Solidity: function setMinDataStoreFee(uint64 minDataStoreFee_) returns()
func (_Dynamics *DynamicsSession) SetMinDataStoreFee(minDataStoreFee_ uint64) (*types.Transaction, error) {
	return _Dynamics.Contract.SetMinDataStoreFee(&_Dynamics.TransactOpts, minDataStoreFee_)
}

// SetMinDataStoreFee is a paid mutator transaction binding the contract method 0x5361cc6b.
//
// Solidity: function setMinDataStoreFee(uint64 minDataStoreFee_) returns()
func (_Dynamics *DynamicsTransactorSession) SetMinDataStoreFee(minDataStoreFee_ uint64) (*types.Transaction, error) {
	return _Dynamics.Contract.SetMinDataStoreFee(&_Dynamics.TransactOpts, minDataStoreFee_)
}
...
func (_Dynamics *DynamicsTransactor) SetMinMaxBlockSize(opts *bind.TransactOpts, minMaxBlockSize_ uint32) (*types.Transaction, error) {
	return _Dynamics.contract.Transact(opts, "setMinMaxBlockSize", minMaxBlockSize_)
}

// SetMinMaxBlockSize is a paid mutator transaction binding the contract method 0x6aca1b3a.
//
// Solidity: function setMinMaxBlockSize(uint32 minMaxBlockSize_) returns()
func (_Dynamics *DynamicsSession) SetMinMaxBlockSize(minMaxBlockSize_ uint32) (*types.Transaction, error) {
	return _Dynamics.Contract.SetMinMaxBlockSize(&_Dynamics.TransactOpts, minMaxBlockSize_)
}

// SetMinMaxBlockSize is a paid mutator transaction binding the contract method 0x6aca1b3a.
//
// Solidity: function setMinMaxBlockSize(uint32 minMaxBlockSize_) returns()
func (_Dynamics *DynamicsTransactorSession) SetMinMaxBlockSize(minMaxBlockSize_ uint32) (*types.Transaction, error) {
	return _Dynamics.Contract.SetMinMaxBlockSize(&_Dynamics.TransactOpts, minMaxBlockSize_)
}
...
func (_Dynamics *DynamicsTransactor) SetMinMinScaledTransactionFee(opts *bind.TransactOpts, minMinScaledTransactionFee_ *big.Int) (*types.Transaction, error) {
	return _Dynamics.contract.Transact(opts, "setMinMinScaledTransactionFee", minMinScaledTransactionFee_)
}

// SetMinMinScaledTransactionFee is a paid mutator transaction binding the contract method 0xddc9c616.
//
// Solidity: function setMinMinScaledTransactionFee(uint128 minMinScaledTransactionFee_) returns()
func (_Dynamics *DynamicsSession) SetMinMinScaledTransactionFee(minMinScaledTransactionFee_ *big.Int) (*types.Transaction, error) {
	return _Dynamics.Contract.SetMinMinScaledTransactionFee(&_Dynamics.TransactOpts, minMinScaledTransactionFee_)
}

// SetMinMinScaledTransactionFee is a paid mutator transaction binding the contract method 0xddc9c616.
//
// Solidity: function setMinMinScaledTransactionFee(uint128 minMinScaledTransactionFee_) returns()
func (_Dynamics *DynamicsTransactorSession) SetMinMinScaledTransactionFee(minMinScaledTransactionFee_ *big.Int) (*types.Transaction, error) {
	return _Dynamics.Contract.SetMinMinScaledTransactionFee(&_Dynamics.TransactOpts, minMinScaledTransactionFee_)
}
...
func (_Dynamics *DynamicsTransactor) SetMinPreCommitTimeout(opts *bind.TransactOpts, minPreCommitTimeout_ uint32) (*types.Transaction, error) {
	return _Dynamics.contract.Transact(opts, "setMinPreCommitTimeout", minPreCommitTimeout_)
}

// SetMinPreCommitTimeout is a paid mutator transaction binding the contract method 0x5129bfb9.
//
// Solidity: function setMinPreCommitTimeout(uint32 minPreCommitTimeout_) returns()
func (_Dynamics *DynamicsSession) SetMinPreCommitTimeout(minPreCommitTimeout_ uint32) (*types.Transaction, error) {
	return _Dynamics.Contract.SetMinPreCommitTimeout(&_Dynamics.TransactOpts, minPreCommitTimeout_)
}

// SetMinPreCommitTimeout is a paid mutator transaction binding the contract method 0x5129bfb9.
//
// Solidity: function setMinPreCommitTimeout(uint32 minPreCommitTimeout_) returns()
func (_Dynamics *DynamicsTransactorSession) SetMinPreCommitTimeout(minPreCommitTimeout_ uint32) (*types.Transaction, error) {
	return _Dynamics.Contract.SetMinPreCommitTimeout(&_Dynamics.TransactOpts, minPreCommitTimeout_)
}
...
func (_Dynamics *DynamicsTransactor) SetMinPreVoteTimeout(opts *bind.TransactOpts, minPreVoteTimeout_ uint32) (*types.Transaction, error) {
	return _Dynamics.contract.Transact(opts, "setMinPreVoteTimeout", minPreVoteTimeout_)
}

// SetMinPreVoteTimeout is a paid mutator transaction binding the contract method 0x30d7649a.
//
// Solidity: function setMinPreVoteTimeout(uint32 minPreVoteTimeout_) returns()
func (_Dynamics *DynamicsSession) SetMinPreVoteTimeout(minPreVoteTimeout_ uint32) (*types.Transaction, error) {
	return _Dynamics.Contract.SetMinPreVoteTimeout(&_Dynamics.TransactOpts, minPreVoteTimeout_)
}

// SetMinPreVoteTimeout is a paid mutator transaction binding the contract method 0x30d7649a.
//
// Solidity: function setMinPreVoteTimeout(uint32 minPreVoteTimeout_) returns()
func (_Dynamics *DynamicsTransactorSession) SetMinPreVoteTimeout(minPreVoteTimeout_ uint32) (*types.Transaction, error) {
	return _Dynamics.Contract.SetMinPreVoteTimeout(&_Dynamics.TransactOpts, minPreVoteTimeout_)
}
...
func (_Dynamics *DynamicsTransactor) SetMinProposalTimeout(opts *bind.TransactOpts, minProposalTimeout_ *big.Int) (*types.Transaction, error) {
	return _Dynamics.contract.Transact(opts, "setMinProposalTimeout", minProposalTimeout_)
}

// SetMinProposalTimeout is a paid mutator transaction binding the contract method 0xfbffa08a.
//
// Solidity: function setMinProposalTimeout(uint24 minProposalTimeout_) returns()
func (_Dynamics *DynamicsSession) SetMinProposalTimeout(minProposalTimeout_ *big.Int) (*types.Transaction, error) {
	return _Dynamics.Contract.SetMinProposalTimeout(&_Dynamics.TransactOpts, minProposalTimeout_)
}

// SetMinProposalTimeout is a paid mutator transaction binding the contract method 0xfbffa08a.
//
// Solidity: function setMinProposalTimeout(uint24 minProposalTimeout_) returns()
func (_Dynamics *DynamicsTransactorSession) SetMinProposalTimeout(minProposalTimeout_ *big.Int) (*types.Transaction, error) {
	return _Dynamics.Contract.SetMinProposalTimeout(&_Dynamics.TransactOpts, minProposalTimeout_)
}
...
func (_Dynamics *DynamicsTransactor) SetMinValueStoreFee(opts *bind.TransactOpts, minValueStoreFee_ uint64) (*types.Transaction, error) {
	return _Dynamics.contract.Transact(opts, "setMinValueStoreFee", minValueStoreFee_)
}

// SetMinValueStoreFee is a paid mutator transaction binding the contract method 0x47d3fdd0.
//
// Solidity: function setMinValueStoreFee(uint64 minValueStoreFee_) returns()
func (_Dynamics *DynamicsSession) SetMinValueStoreFee(minValueStoreFee_ uint64) (*types.Transaction, error) {
	return _Dynamics.Contract.SetMinValueStoreFee(&_Dynamics.TransactOpts, minValueStoreFee_)
}

// SetMinValueStoreFee is a paid mutator transaction binding the contract method 0x47d3fdd0.
//
// Solidity: function setMinValueStoreFee(uint64 minValueStoreFee_) returns()
func (_Dynamics *DynamicsTransactorSession) SetMinValueStoreFee(minValueStoreFee_ uint64) (*types.Transaction, error) {
	return _Dynamics.Contract.SetMinValueStoreFee(&_Dynamics.TransactOpts, minValueStoreFee_)
}
...
type DynamicsNewCanonicalAliceNetNodeVersionIterator struct {
	Event *DynamicsNewCanonicalAliceNetNodeVersion // Event containing the contract specifics and raw log
...
func (it *DynamicsNewCanonicalAliceNetNodeVersionIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(DynamicsNewCanonicalAliceNetNodeVersion)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type DynamicsNewCanonicalAliceNetNodeVersion struct {
	Version CanonicalVersion
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_Dynamics *DynamicsFilterer) FilterNewCanonicalAliceNetNodeVersion(opts *bind.FilterOpts) (*DynamicsNewCanonicalAliceNetNodeVersionIterator, error) {
	...
	logs, sub, err := _Dynamics.contract.FilterLogs(opts, "NewCanonicalAliceNetNodeVersion")
	if err != nil {
		return nil, err
	}
	return &DynamicsNewCanonicalAliceNetNodeVersionIterator{contract: _Dynamics.contract, event: "NewCanonicalAliceNetNodeVersion", logs: logs, sub: sub}, nil
}
...
func (_Dynamics *DynamicsFilterer) WatchNewCanonicalAliceNetNodeVersion(opts *bind.WatchOpts, sink chan<- *DynamicsNewCanonicalAliceNetNodeVersion) (event.Subscription, error) {
	...
	logs, sub, err := _Dynamics.contract.WatchLogs(opts, "NewCanonicalAliceNetNodeVersion")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(DynamicsNewCanonicalAliceNetNodeVersion)
				if err := _Dynamics.contract.UnpackLog(event, "NewCanonicalAliceNetNodeVersion", log); err != nil {
					return err
				}
				event.Raw = log
