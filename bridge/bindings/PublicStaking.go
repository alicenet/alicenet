...
func (_PublicStaking *PublicStakingCaller) GetStaticPoolContractAddress(opts *bind.CallOpts, _salt [32]byte, _bridgeRouter common.Address) (common.Address, error) {
	var out []interface{}
	err := _PublicStaking.contract.Call(opts, &out, "getStaticPoolContractAddress", _salt, _bridgeRouter)
...
//
// Solidity: function getStaticPoolContractAddress(bytes32 _salt, address _bridgeRouter) pure returns(address)
func (_PublicStaking *PublicStakingSession) GetStaticPoolContractAddress(_salt [32]byte, _bridgeRouter common.Address) (common.Address, error) {
	return _PublicStaking.Contract.GetStaticPoolContractAddress(&_PublicStaking.CallOpts, _salt, _bridgeRouter)
}

// GetStaticPoolContractAddress is a free data retrieval call binding the contract method 0x0ffd7a81.
//
// Solidity: function getStaticPoolContractAddress(bytes32 _salt, address _bridgeRouter) pure returns(address)
func (_PublicStaking *PublicStakingCallerSession) GetStaticPoolContractAddress(_salt [32]byte, _bridgeRouter common.Address) (common.Address, error) {
	return _PublicStaking.Contract.GetStaticPoolContractAddress(&_PublicStaking.CallOpts, _salt, _bridgeRouter)
}
...
func (_PublicStaking *PublicStakingCaller) TokenURI(opts *bind.CallOpts, tokenId *big.Int) (string, error) {
	var out []interface{}
	err := _PublicStaking.contract.Call(opts, &out, "tokenURI", tokenId)
...
//
// Solidity: function tokenURI(uint256 tokenId) view returns(string)
func (_PublicStaking *PublicStakingSession) TokenURI(tokenId *big.Int) (string, error) {
	return _PublicStaking.Contract.TokenURI(&_PublicStaking.CallOpts, tokenId)
}

// TokenURI is a free data retrieval call binding the contract method 0xc87b56dd.
//
// Solidity: function tokenURI(uint256 tokenId) view returns(string)
func (_PublicStaking *PublicStakingCallerSession) TokenURI(tokenId *big.Int) (string, error) {
	return _PublicStaking.Contract.TokenURI(&_PublicStaking.CallOpts, tokenId)
}
