...
func (_ETHDKG *ETHDKGCaller) GetStaticPoolContractAddress(opts *bind.CallOpts, _salt [32]byte, _bridgeRouter common.Address) (common.Address, error) {
	var out []interface{}
	err := _ETHDKG.contract.Call(opts, &out, "getStaticPoolContractAddress", _salt, _bridgeRouter)
...
//
// Solidity: function getStaticPoolContractAddress(bytes32 _salt, address _bridgeRouter) pure returns(address)
func (_ETHDKG *ETHDKGSession) GetStaticPoolContractAddress(_salt [32]byte, _bridgeRouter common.Address) (common.Address, error) {
	return _ETHDKG.Contract.GetStaticPoolContractAddress(&_ETHDKG.CallOpts, _salt, _bridgeRouter)
}

// GetStaticPoolContractAddress is a free data retrieval call binding the contract method 0x0ffd7a81.
//
// Solidity: function getStaticPoolContractAddress(bytes32 _salt, address _bridgeRouter) pure returns(address)
func (_ETHDKG *ETHDKGCallerSession) GetStaticPoolContractAddress(_salt [32]byte, _bridgeRouter common.Address) (common.Address, error) {
	return _ETHDKG.Contract.GetStaticPoolContractAddress(&_ETHDKG.CallOpts, _salt, _bridgeRouter)
}
