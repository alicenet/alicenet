...
func (_ValidatorPool *ValidatorPoolCaller) GetValidatorStakingPosition(opts *bind.CallOpts, tokenID *big.Int) (struct {
	Shares            *big.Int
	FreeAfter         *big.Int
	...
	var out []interface{}
	err := _ValidatorPool.contract.Call(opts, &out, "getValidatorStakingPosition", tokenID)
...
//
// Solidity: function getValidatorStakingPosition(uint256 tokenID) view returns(uint256 shares, uint256 freeAfter, uint256 withdrawFreeAfter, uint256 accumulatorEth, uint256 accumulatorToken)
func (_ValidatorPool *ValidatorPoolSession) GetValidatorStakingPosition(tokenID *big.Int) (struct {
	Shares            *big.Int
	FreeAfter         *big.Int
	WithdrawFreeAfter *big.Int
	AccumulatorEth    *big.Int
	...
	return _ValidatorPool.Contract.GetValidatorStakingPosition(&_ValidatorPool.CallOpts, tokenID)
}

// GetValidatorStakingPosition is a free data retrieval call binding the contract method 0x04513d45.
//
// Solidity: function getValidatorStakingPosition(uint256 tokenID) view returns(uint256 shares, uint256 freeAfter, uint256 withdrawFreeAfter, uint256 accumulatorEth, uint256 accumulatorToken)
func (_ValidatorPool *ValidatorPoolCallerSession) GetValidatorStakingPosition(tokenID *big.Int) (struct {
	Shares            *big.Int
	FreeAfter         *big.Int
	WithdrawFreeAfter *big.Int
	AccumulatorEth    *big.Int
