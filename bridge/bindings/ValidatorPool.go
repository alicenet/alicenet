...
func (_ValidatorPool *ValidatorPoolCaller) GetArbitraryContractAddress(opts *bind.CallOpts, _salt [32]byte, _factory common.Address, byteCodeHash_ [32]byte) (common.Address, error) {
	var out []interface{}
	err := _ValidatorPool.contract.Call(opts, &out, "getArbitraryContractAddress", _salt, _factory, byteCodeHash_)
...
//
// Solidity: function getArbitraryContractAddress(bytes32 _salt, address _factory, bytes32 byteCodeHash_) pure returns(address)
func (_ValidatorPool *ValidatorPoolSession) GetArbitraryContractAddress(_salt [32]byte, _factory common.Address, byteCodeHash_ [32]byte) (common.Address, error) {
	return _ValidatorPool.Contract.GetArbitraryContractAddress(&_ValidatorPool.CallOpts, _salt, _factory, byteCodeHash_)
}

// GetArbitraryContractAddress is a free data retrieval call binding the contract method 0x3cd1efee.
//
// Solidity: function getArbitraryContractAddress(bytes32 _salt, address _factory, bytes32 byteCodeHash_) pure returns(address)
func (_ValidatorPool *ValidatorPoolCallerSession) GetArbitraryContractAddress(_salt [32]byte, _factory common.Address, byteCodeHash_ [32]byte) (common.Address, error) {
	return _ValidatorPool.Contract.GetArbitraryContractAddress(&_ValidatorPool.CallOpts, _salt, _factory, byteCodeHash_)
}
