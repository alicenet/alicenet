...
func (_ValidatorPool *ValidatorPoolTransactor) Initialize(opts *bind.TransactOpts, stakeAmount_ *big.Int, maxNumValidators_ *big.Int, disputerReward_ *big.Int, maxIntervalWithoutSnapshots *big.Int) (*types.Transaction, error) {
	return _ValidatorPool.contract.Transact(opts, "initialize", stakeAmount_, maxNumValidators_, disputerReward_, maxIntervalWithoutSnapshots)
}

// Initialize is a paid mutator transaction binding the contract method 0x60a2da44.
//
// Solidity: function initialize(uint256 stakeAmount_, uint256 maxNumValidators_, uint256 disputerReward_, uint256 maxIntervalWithoutSnapshots) returns()
func (_ValidatorPool *ValidatorPoolSession) Initialize(stakeAmount_ *big.Int, maxNumValidators_ *big.Int, disputerReward_ *big.Int, maxIntervalWithoutSnapshots *big.Int) (*types.Transaction, error) {
	return _ValidatorPool.Contract.Initialize(&_ValidatorPool.TransactOpts, stakeAmount_, maxNumValidators_, disputerReward_, maxIntervalWithoutSnapshots)
}

// Initialize is a paid mutator transaction binding the contract method 0x60a2da44.
//
// Solidity: function initialize(uint256 stakeAmount_, uint256 maxNumValidators_, uint256 disputerReward_, uint256 maxIntervalWithoutSnapshots) returns()
func (_ValidatorPool *ValidatorPoolTransactorSession) Initialize(stakeAmount_ *big.Int, maxNumValidators_ *big.Int, disputerReward_ *big.Int, maxIntervalWithoutSnapshots *big.Int) (*types.Transaction, error) {
	return _ValidatorPool.Contract.Initialize(&_ValidatorPool.TransactOpts, stakeAmount_, maxNumValidators_, disputerReward_, maxIntervalWithoutSnapshots)
}
