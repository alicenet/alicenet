...
func (_AccusationInvalidTxConsumption *AccusationInvalidTxConsumptionTransactor) AccuseInvalidTransactionConsumption(opts *bind.TransactOpts, _pClaims []byte, _pClaimsSig []byte, _bClaims []byte, _bClaimsSigGroup []byte, _txInPreImage []byte, _proofs [3][]byte) (*types.Transaction, error) {
	return _AccusationInvalidTxConsumption.contract.Transact(opts, "accuseInvalidTransactionConsumption", _pClaims, _pClaimsSig, _bClaims, _bClaimsSigGroup, _txInPreImage, _proofs)
}

// AccuseInvalidTransactionConsumption is a paid mutator transaction binding the contract method 0x6ae40457.
//
// Solidity: function accuseInvalidTransactionConsumption(bytes _pClaims, bytes _pClaimsSig, bytes _bClaims, bytes _bClaimsSigGroup, bytes _txInPreImage, bytes[3] _proofs) returns(address)
func (_AccusationInvalidTxConsumption *AccusationInvalidTxConsumptionSession) AccuseInvalidTransactionConsumption(_pClaims []byte, _pClaimsSig []byte, _bClaims []byte, _bClaimsSigGroup []byte, _txInPreImage []byte, _proofs [3][]byte) (*types.Transaction, error) {
	return _AccusationInvalidTxConsumption.Contract.AccuseInvalidTransactionConsumption(&_AccusationInvalidTxConsumption.TransactOpts, _pClaims, _pClaimsSig, _bClaims, _bClaimsSigGroup, _txInPreImage, _proofs)
}

// AccuseInvalidTransactionConsumption is a paid mutator transaction binding the contract method 0x6ae40457.
//
// Solidity: function accuseInvalidTransactionConsumption(bytes _pClaims, bytes _pClaimsSig, bytes _bClaims, bytes _bClaimsSigGroup, bytes _txInPreImage, bytes[3] _proofs) returns(address)
func (_AccusationInvalidTxConsumption *AccusationInvalidTxConsumptionTransactorSession) AccuseInvalidTransactionConsumption(_pClaims []byte, _pClaimsSig []byte, _bClaims []byte, _bClaimsSigGroup []byte, _txInPreImage []byte, _proofs [3][]byte) (*types.Transaction, error) {
	return _AccusationInvalidTxConsumption.Contract.AccuseInvalidTransactionConsumption(&_AccusationInvalidTxConsumption.TransactOpts, _pClaims, _pClaimsSig, _bClaims, _bClaimsSigGroup, _txInPreImage, _proofs)
}
