...
func (_AccusationInvalidTxConsumption *AccusationInvalidTxConsumptionCaller) IsAccused(opts *bind.CallOpts, id_ [32]byte) (bool, error) {
	var out []interface{}
	err := _AccusationInvalidTxConsumption.contract.Call(opts, &out, "isAccused", id_)
...
//
// Solidity: function isAccused(bytes32 id_) view returns(bool)
func (_AccusationInvalidTxConsumption *AccusationInvalidTxConsumptionSession) IsAccused(id_ [32]byte) (bool, error) {
	return _AccusationInvalidTxConsumption.Contract.IsAccused(&_AccusationInvalidTxConsumption.CallOpts, id_)
}

// IsAccused is a free data retrieval call binding the contract method 0x5e773967.
//
// Solidity: function isAccused(bytes32 id_) view returns(bool)
func (_AccusationInvalidTxConsumption *AccusationInvalidTxConsumptionCallerSession) IsAccused(id_ [32]byte) (bool, error) {
	return _AccusationInvalidTxConsumption.Contract.IsAccused(&_AccusationInvalidTxConsumption.CallOpts, id_)
}
