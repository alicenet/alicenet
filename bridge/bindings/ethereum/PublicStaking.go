...
func (_PublicStaking *PublicStakingCaller) EstimateAllProfits(opts *bind.CallOpts, tokenID_ *big.Int) (struct {
	PayoutEth   *big.Int
	PayoutToken *big.Int
}, error) {
	var out []interface{}
	err := _PublicStaking.contract.Call(opts, &out, "estimateAllProfits", tokenID_)
...
//
// Solidity: function estimateAllProfits(uint256 tokenID_) view returns(uint256 payoutEth, uint256 payoutToken)
func (_PublicStaking *PublicStakingSession) EstimateAllProfits(tokenID_ *big.Int) (struct {
	PayoutEth   *big.Int
	PayoutToken *big.Int
}, error) {
	return _PublicStaking.Contract.EstimateAllProfits(&_PublicStaking.CallOpts, tokenID_)
}

// EstimateAllProfits is a free data retrieval call binding the contract method 0x4fc8638f.
//
// Solidity: function estimateAllProfits(uint256 tokenID_) view returns(uint256 payoutEth, uint256 payoutToken)
func (_PublicStaking *PublicStakingCallerSession) EstimateAllProfits(tokenID_ *big.Int) (struct {
	PayoutEth   *big.Int
	PayoutToken *big.Int
}, error) {
	return _PublicStaking.Contract.EstimateAllProfits(&_PublicStaking.CallOpts, tokenID_)
...
func (_PublicStaking *PublicStakingCaller) GetTotalReserveALCA(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _PublicStaking.contract.Call(opts, &out, "getTotalReserveALCA")
...
func (_PublicStaking *PublicStakingSession) GetTotalReserveALCA() (*big.Int, error) {
	return _PublicStaking.Contract.GetTotalReserveALCA(&_PublicStaking.CallOpts)
}
