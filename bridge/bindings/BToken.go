...
func (_BToken *BTokenTransactor) AddAccountType(opts *bind.TransactOpts, accountType_ uint8) (*types.Transaction, error) {
	return _BToken.contract.Transact(opts, "addAccountType", accountType_)
}

// AddAccountType is a paid mutator transaction binding the contract method 0xb002f35b.
//
// Solidity: function addAccountType(uint8 accountType_) returns()
func (_BToken *BTokenSession) AddAccountType(accountType_ uint8) (*types.Transaction, error) {
	return _BToken.Contract.AddAccountType(&_BToken.TransactOpts, accountType_)
}

// AddAccountType is a paid mutator transaction binding the contract method 0xb002f35b.
//
// Solidity: function addAccountType(uint8 accountType_) returns()
func (_BToken *BTokenTransactorSession) AddAccountType(accountType_ uint8) (*types.Transaction, error) {
	return _BToken.Contract.AddAccountType(&_BToken.TransactOpts, accountType_)
}
