...
func (_BToken *BTokenCaller) GetStaticPoolContractAddress(opts *bind.CallOpts, _salt [32]byte, _bridgeRouter common.Address) (common.Address, error) {
	var out []interface{}
	err := _BToken.contract.Call(opts, &out, "getStaticPoolContractAddress", _salt, _bridgeRouter)
...
//
// Solidity: function getStaticPoolContractAddress(bytes32 _salt, address _bridgeRouter) pure returns(address)
func (_BToken *BTokenSession) GetStaticPoolContractAddress(_salt [32]byte, _bridgeRouter common.Address) (common.Address, error) {
	return _BToken.Contract.GetStaticPoolContractAddress(&_BToken.CallOpts, _salt, _bridgeRouter)
}

// GetStaticPoolContractAddress is a free data retrieval call binding the contract method 0x0ffd7a81.
//
// Solidity: function getStaticPoolContractAddress(bytes32 _salt, address _bridgeRouter) pure returns(address)
func (_BToken *BTokenCallerSession) GetStaticPoolContractAddress(_salt [32]byte, _bridgeRouter common.Address) (common.Address, error) {
	return _BToken.Contract.GetStaticPoolContractAddress(&_BToken.CallOpts, _salt, _bridgeRouter)
}
...
func (_BToken *BTokenTransactor) Hello(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _BToken.contract.Transact(opts, "hello")
}

// Hello is a paid mutator transaction binding the contract method 0x19ff1d21.
//
// Solidity: function hello() returns()
func (_BToken *BTokenSession) Hello() (*types.Transaction, error) {
	return _BToken.Contract.Hello(&_BToken.TransactOpts)
}

// Hello is a paid mutator transaction binding the contract method 0x19ff1d21.
//
// Solidity: function hello() returns()
func (_BToken *BTokenTransactorSession) Hello() (*types.Transaction, error) {
	return _BToken.Contract.Hello(&_BToken.TransactOpts)
}
...
func (_BToken *BTokenTransactor) PayAndDeposit(opts *bind.TransactOpts, maxEth *big.Int, maxTokens *big.Int, data []byte) (*types.Transaction, error) {
	return _BToken.contract.Transact(opts, "payAndDeposit", maxEth, maxTokens, data)
}

// PayAndDeposit is a paid mutator transaction binding the contract method 0x0e30f5d3.
//
// Solidity: function payAndDeposit(uint256 maxEth, uint256 maxTokens, bytes data) payable returns()
func (_BToken *BTokenSession) PayAndDeposit(maxEth *big.Int, maxTokens *big.Int, data []byte) (*types.Transaction, error) {
	return _BToken.Contract.PayAndDeposit(&_BToken.TransactOpts, maxEth, maxTokens, data)
}

// PayAndDeposit is a paid mutator transaction binding the contract method 0x0e30f5d3.
//
// Solidity: function payAndDeposit(uint256 maxEth, uint256 maxTokens, bytes data) payable returns()
func (_BToken *BTokenTransactorSession) PayAndDeposit(maxEth *big.Int, maxTokens *big.Int, data []byte) (*types.Transaction, error) {
	return _BToken.Contract.PayAndDeposit(&_BToken.TransactOpts, maxEth, maxTokens, data)
}
