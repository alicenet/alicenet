...
func (_BToken *BTokenCaller) GetBridgeRouterAddress(opts *bind.CallOpts, routerVersion_ uint8) (common.Address, error) {
	var out []interface{}
	err := _BToken.contract.Call(opts, &out, "getBridgeRouterAddress", routerVersion_)
...
//
// Solidity: function getBridgeRouterAddress(uint8 routerVersion_) view returns(address)
func (_BToken *BTokenSession) GetBridgeRouterAddress(routerVersion_ uint8) (common.Address, error) {
	return _BToken.Contract.GetBridgeRouterAddress(&_BToken.CallOpts, routerVersion_)
}

// GetBridgeRouterAddress is a free data retrieval call binding the contract method 0xf4d35744.
//
// Solidity: function getBridgeRouterAddress(uint8 routerVersion_) view returns(address)
func (_BToken *BTokenCallerSession) GetBridgeRouterAddress(routerVersion_ uint8) (common.Address, error) {
	return _BToken.Contract.GetBridgeRouterAddress(&_BToken.CallOpts, routerVersion_)
}
...
func (_BToken *BTokenTransactor) DepositTokensOnBridges(opts *bind.TransactOpts, routerVersion_ uint8, data_ []byte) (*types.Transaction, error) {
	return _BToken.contract.Transact(opts, "depositTokensOnBridges", routerVersion_, data_)
}

// DepositTokensOnBridges is a paid mutator transaction binding the contract method 0xc4602af3.
//
// Solidity: function depositTokensOnBridges(uint8 routerVersion_, bytes data_) payable returns()
func (_BToken *BTokenSession) DepositTokensOnBridges(routerVersion_ uint8, data_ []byte) (*types.Transaction, error) {
	return _BToken.Contract.DepositTokensOnBridges(&_BToken.TransactOpts, routerVersion_, data_)
}

// DepositTokensOnBridges is a paid mutator transaction binding the contract method 0xc4602af3.
//
// Solidity: function depositTokensOnBridges(uint8 routerVersion_, bytes data_) payable returns()
func (_BToken *BTokenTransactorSession) DepositTokensOnBridges(routerVersion_ uint8, data_ []byte) (*types.Transaction, error) {
	return _BToken.Contract.DepositTokensOnBridges(&_BToken.TransactOpts, routerVersion_, data_)
}
...
func (_BToken *BTokenTransactor) SetBridgeRouterAddress(opts *bind.TransactOpts, newAddress_ common.Address, routerVersion_ uint8) (*types.Transaction, error) {
	return _BToken.contract.Transact(opts, "setBridgeRouterAddress", newAddress_, routerVersion_)
}

// SetBridgeRouterAddress is a paid mutator transaction binding the contract method 0xe0a79bcf.
//
// Solidity: function setBridgeRouterAddress(address newAddress_, uint8 routerVersion_) returns()
func (_BToken *BTokenSession) SetBridgeRouterAddress(newAddress_ common.Address, routerVersion_ uint8) (*types.Transaction, error) {
	return _BToken.Contract.SetBridgeRouterAddress(&_BToken.TransactOpts, newAddress_, routerVersion_)
}

// SetBridgeRouterAddress is a paid mutator transaction binding the contract method 0xe0a79bcf.
//
// Solidity: function setBridgeRouterAddress(address newAddress_, uint8 routerVersion_) returns()
func (_BToken *BTokenTransactorSession) SetBridgeRouterAddress(newAddress_ common.Address, routerVersion_ uint8) (*types.Transaction, error) {
	return _BToken.Contract.SetBridgeRouterAddress(&_BToken.TransactOpts, newAddress_, routerVersion_)
}
