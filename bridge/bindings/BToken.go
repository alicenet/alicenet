...
func (_BToken *BTokenTransactor) SetAccountType(opts *bind.TransactOpts, accountType_ uint8, allowed_ bool) (*types.Transaction, error) {
	return _BToken.contract.Transact(opts, "setAccountType", accountType_, allowed_)
}

// SetAccountType is a paid mutator transaction binding the contract method 0x14c8d876.
//
// Solidity: function setAccountType(uint8 accountType_, bool allowed_) returns()
func (_BToken *BTokenSession) SetAccountType(accountType_ uint8, allowed_ bool) (*types.Transaction, error) {
	return _BToken.Contract.SetAccountType(&_BToken.TransactOpts, accountType_, allowed_)
}

// SetAccountType is a paid mutator transaction binding the contract method 0x14c8d876.
//
// Solidity: function setAccountType(uint8 accountType_, bool allowed_) returns()
func (_BToken *BTokenTransactorSession) SetAccountType(accountType_ uint8, allowed_ bool) (*types.Transaction, error) {
	return _BToken.Contract.SetAccountType(&_BToken.TransactOpts, accountType_, allowed_)
}
