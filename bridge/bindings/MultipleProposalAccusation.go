...
func (_MultipleProposalAccusation *MultipleProposalAccusationCaller) CalculateId(opts *bind.CallOpts, signature0_ []byte, pClaims0_ []byte, signature1_ []byte, pClaims1_ []byte) ([32]byte, error) {
	var out []interface{}
	err := _MultipleProposalAccusation.contract.Call(opts, &out, "calculateId", signature0_, pClaims0_, signature1_, pClaims1_)
...
//
// Solidity: function calculateId(bytes signature0_, bytes pClaims0_, bytes signature1_, bytes pClaims1_) pure returns(bytes32)
func (_MultipleProposalAccusation *MultipleProposalAccusationSession) CalculateId(signature0_ []byte, pClaims0_ []byte, signature1_ []byte, pClaims1_ []byte) ([32]byte, error) {
	return _MultipleProposalAccusation.Contract.CalculateId(&_MultipleProposalAccusation.CallOpts, signature0_, pClaims0_, signature1_, pClaims1_)
}

// CalculateId is a free data retrieval call binding the contract method 0x367c6285.
//
// Solidity: function calculateId(bytes signature0_, bytes pClaims0_, bytes signature1_, bytes pClaims1_) pure returns(bytes32)
func (_MultipleProposalAccusation *MultipleProposalAccusationCallerSession) CalculateId(signature0_ []byte, pClaims0_ []byte, signature1_ []byte, pClaims1_ []byte) ([32]byte, error) {
	return _MultipleProposalAccusation.Contract.CalculateId(&_MultipleProposalAccusation.CallOpts, signature0_, pClaims0_, signature1_, pClaims1_)
}
