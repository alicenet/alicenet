...
func (_ValidatorStaking *ValidatorStakingCaller) EstimateAllProfits(opts *bind.CallOpts, tokenID_ *big.Int) (struct {
	PayoutEth   *big.Int
	PayoutToken *big.Int
}, error) {
	var out []interface{}
	err := _ValidatorStaking.contract.Call(opts, &out, "estimateAllProfits", tokenID_)
	...
	outstruct.PayoutEth = *abi.ConvertType(out[0], new(*big.Int)).(**big.Int)
	outstruct.PayoutToken = *abi.ConvertType(out[1], new(*big.Int)).(**big.Int)
...
//
// Solidity: function estimateAllProfits(uint256 tokenID_) view returns(uint256 payoutEth, uint256 payoutToken)
func (_ValidatorStaking *ValidatorStakingSession) EstimateAllProfits(tokenID_ *big.Int) (struct {
	PayoutEth   *big.Int
	PayoutToken *big.Int
}, error) {
	return _ValidatorStaking.Contract.EstimateAllProfits(&_ValidatorStaking.CallOpts, tokenID_)
}

// EstimateAllProfits is a free data retrieval call binding the contract method 0x4fc8638f.
//
// Solidity: function estimateAllProfits(uint256 tokenID_) view returns(uint256 payoutEth, uint256 payoutToken)
func (_ValidatorStaking *ValidatorStakingCallerSession) EstimateAllProfits(tokenID_ *big.Int) (struct {
	PayoutEth   *big.Int
	PayoutToken *big.Int
}, error) {
	return _ValidatorStaking.Contract.EstimateAllProfits(&_ValidatorStaking.CallOpts, tokenID_)
...
func (_ValidatorStaking *ValidatorStakingCaller) GetTotalReserveALCA(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ValidatorStaking.contract.Call(opts, &out, "getTotalReserveALCA")
...
func (_ValidatorStaking *ValidatorStakingSession) GetTotalReserveALCA() (*big.Int, error) {
	return _ValidatorStaking.Contract.GetTotalReserveALCA(&_ValidatorStaking.CallOpts)
}
