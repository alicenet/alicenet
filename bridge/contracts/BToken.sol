    ...
    ImmutableDistribution
{
    ...
    /// access to them in the side chain. This function will deduct from the user's
    ...
    /// function will deduct the fee amount and refund any extra amount. If no ether
    /// is sent, the function will deduct the amount of BToken corresponding to the
