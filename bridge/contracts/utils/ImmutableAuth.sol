...
abstract contract ImmutableNativeERC721BridgePoolV1 is ImmutableFactory {
    ...
    constructor() {
        _nativeERC721BridgePoolV1 = getMetamorphicContractAddress(0x4e6174697665455243373231427269646765506f6f6c56310000000000000000, _factoryAddress());
    }
...
abstract contract ImmutableNativeERCBridgePoolBase is ImmutableFactory {
    ...
    constructor() {
        _nativeERCBridgePoolBase = getMetamorphicContractAddress(0x4e6174697665455243427269646765506f6f6c42617365000000000000000000, _factoryAddress());
    }
