...
abstract contract ImmutableBridgePoolFactory is ImmutableFactory {
    ...
    constructor() {
        _bridgePoolFactory = getMetamorphicContractAddress(0x427269646765506f6f6c466163746f7279000000000000000000000000000000, _factoryAddress());
    }
...
abstract contract ImmutableDistribution is ImmutableFactory {
    ...
    constructor() {
        _distribution = getMetamorphicContractAddress(0x446973747269627574696f6e0000000000000000000000000000000000000000, _factoryAddress());
    }
...
abstract contract ImmutableDynamics is ImmutableFactory {
    ...
    constructor() {
        _dynamics = getMetamorphicContractAddress(0x44796e616d696373000000000000000000000000000000000000000000000000, _factoryAddress());
    }
...
abstract contract ImmutableInvalidTxConsumptionAccusation is ImmutableFactory {
    ...
    constructor() {
        _invalidTxConsumptionAccusation = getMetamorphicContractAddress(0x92a73f2b6573522d63c8fc84b5d8e5d615fbb685c1b3d7fad2155fe227daf848, _factoryAddress());
    }
...
abstract contract ImmutableLocalERC1155BridgePoolV1 is ImmutableFactory {
    ...
    constructor() {
        _localERC1155BridgePoolV1 = getMetamorphicContractAddress(0x4c6f63616c45524331313535427269646765506f6f6c56310000000000000000, _factoryAddress());
    }
...
abstract contract ImmutableLocalERC20BridgePoolV1 is ImmutableFactory {
    ...
    constructor() {
        _localERC20BridgePoolV1 = getMetamorphicContractAddress(0x4c6f63616c4552433230427269646765506f6f6c563100000000000000000000, _factoryAddress());
    }
...
abstract contract ImmutableLocalERC721BridgePoolV1 is ImmutableFactory {
    ...
    constructor() {
        _localERC721BridgePoolV1 = getMetamorphicContractAddress(0x4c6f63616c455243373231427269646765506f6f6c5631000000000000000000, _factoryAddress());
    }
...
abstract contract ImmutableMultipleProposalAccusation is ImmutableFactory {
    ...
    constructor() {
        _multipleProposalAccusation = getMetamorphicContractAddress(0xcfdffd500b4a956e03976b2afd69712237ffa06e35093df1e05e533688959fdc, _factoryAddress());
    }
