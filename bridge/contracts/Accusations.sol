    ...
    ImmutableValidatorPool
{
    ...
    function accuseMultipleProposal(
        ...
        require(
            _accusations[id] == false,
            "Accusations: the accusation has already been submitted!"
        );

        // ecrecover sig0/1 and ensure both are valid and accounts are equal
        address signerAccount0 = recoverMadNetSigner(signature0_, pClaims0_);
        address signerAccount1 = recoverMadNetSigner(signature1_, pClaims1_);
