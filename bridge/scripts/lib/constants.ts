...
export const DEPLOY_ALL_CONTRACTS = "deploy-all-contracts";
export const DEPLOY_CREATE = "deploy-create";
export const DEPLOY_CREATE2 = "deploy-create2";
export const DEPLOY_FACTORY = "deploy-factory";
export const DEPLOY_METAMORPHIC = "deploy-metamorphic";
export const DEPLOY_PROXY = "deploy-proxy";
export const DEPLOY_STATIC = "deploy-static";
export const DEPLOY_TEMPLATE = "deploy-template";
export const DEPLOY_UPGRADEABLE_PROXY = "deploy-upgradeable-proxy";
...
export const MULTI_CALL_DEPLOY_PROXY = "multi-call-deploy-proxy";
export const MULTI_CALL_UPGRADE_PROXY = "multi-call-upgrade-proxy";
