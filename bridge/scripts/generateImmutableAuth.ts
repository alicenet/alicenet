...
task("generate-immutable-auth-contract", "Generate contracts")
  ...
  .setAction(async ({ input, output }, hre) => {
    ...
    immutableContract += templateSalt;
...
let templateSalt = `// This file is auto-generated by hardhat generate-immutable-auth-contract task. DO NOT EDIT.
...
abstract contract Immutable${contract.name} is ImmutableFactory {
    ...
    modifier only${contract.name}() {
        require(msg.sender == _${mixedContractName}, "only${contract.name}");
        _;
    }
