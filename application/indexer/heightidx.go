...
// HeightIdxIndex is an indexer which stores the height and index
// of a tx; this is used in the mined tx handler.
...
// Delete removes a tx from the indexer
...
// GetHeightIdx returns the height and index of the tx
