...
var xserviceDef = `{{ $Services := .Services }}// Code generated. DO NOT EDIT.
...
// {{$service.Service}}Dispatch allows handlers to be registered for all RPC methods
// using the Register<Service><Name> methods.
// After registration, the {{$service.Service}}Dispatch struct will dispatch calls
// to an rpc method via the methods named as <Service><Name>(...)
type {{$service.Service}}Dispatch struct {
	sync.Mutex{{range $rpc := $service.RPC}}
  //	handler{{$rpc.Service}}{{$rpc.Name}} is the registered handler for the
	...
	waitChan{{$rpc.Service}}{{$rpc.Name}} chan struct{}{{end}}
}
{{end}}
...
func (d *{{$service.Service}}Dispatch) Register{{$rpc.Service}}{{$rpc.Name}}(t {{$rpc.Service}}{{$rpc.Name}}Handler) {
	d.Lock()
	defer d.Unlock()
...
func (d *{{$service.Service}}Dispatch) {{$rpc.Service}}{{$rpc.Name}}(ctx context.Context, r *{{$rpc.RequestType}}) (*{{$rpc.ReturnsType}}, error) {
...
{{range $service := $Services}}
// New{{$service.Service}}Dispatch will construct a new {{$service.Service}}Dispatcher with all fields properly
// initialized.
func New{{$service.Service}}Dispatch() *{{$service.Service}}Dispatch {
	return &{{$service.Service}}Dispatch{ {{range $service := $Services}}{{range $rpc := $service.RPC}}
...
func NewGenerated{{$service.Service}}Server(dispatch *{{$service.Service}}Dispatch) *Generated{{$service.Service}}Server {
...
var xserviceTest = `{{ $Services := .Services }}// Code generated. DO NOT EDIT.
package {{.Package}}
...
func Test{{$rpc.Service}}{{$rpc.Name}}(t *testing.T) {
	...
	d := New{{$service.Service}}Dispatch()
