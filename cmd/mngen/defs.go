...
var implDef = `{{ $Services := .Services }}// Code generated by mngen. DO NOT EDIT. (@generated)
...
{{range $service := $Services}}
	...
	type {{$service.Service}}Dispatch struct {
		...
		{{range $rpc := $service.RPC}}
			...
			waitChan{{$rpc.Service}}{{$rpc.Name}} chan struct{}
		{{end}}
	}
{{end}}
...
{{range $service := $Services}}
	...
	func New{{$service.Service}}Dispatch() *{{$service.Service}}Dispatch {
		return &{{$service.Service}}Dispatch{
			
			{{range $rpc := $service.RPC}}
				// initialize the wait channel for method {{$rpc.Name}} on service {{$rpc.Service}}
				waitChan{{$rpc.Service}}{{$rpc.Name}}: make(chan struct{}),
			{{end}}
		}
	}
...
var testDef = `{{ $Services := .Services }}// Code generated by mngen. DO NOT EDIT. (@generated)
package {{.Package}}
