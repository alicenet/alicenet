...
func main() {
	...
	options := map[*cobra.Command][]*option{
		&rootCommand: {
			...
			{"chain.ethMonitorDB", "", "", &config.Configuration.Chain.EthMonitorDbPath},
			{"chain.ethMonitorDBInMemory", "", "", &config.Configuration.Chain.EthMonitorDbInMemory},
			{"chain.polygonMonitorDB", "", "", &config.Configuration.Chain.PolygonMonitorDbPath},
			{"chain.polygonMonitorDBInMemory", "", "", &config.Configuration.Chain.PolygonMonitorDbInMemory},
			...
			{"polygon.endpoint", "", "", &config.Configuration.Polygon.Endpoint},
			{"polygon.endpointMinimumPeers", "", "Minimum peers required", &config.Configuration.Polygon.EndpointMinimumPeers},
			{"polygon.keystore", "", "", &config.Configuration.Polygon.Keystore},
			{"polygon.defaultAccount", "", "", &config.Configuration.Polygon.DefaultAccount},
			{"polygon.passCodes", "", "PassCodes for keystore", &config.Configuration.Polygon.PassCodes},
			{"polygon.startingBlock", "", "The first block we care about", &config.Configuration.Polygon.StartingBlock},
			{"polygon.factoryAddress", "", "", &config.Configuration.Polygon.FactoryAddress},
			{"polygon.txMaxGasFeeAllowedInGwei", "", "", &config.Configuration.Polygon.TxMaxGasFeeAllowedInGwei},
			{"polygon.txMetricsDisplay", "", "", &config.Configuration.Polygon.TxMetricsDisplay},
			{"polygon.processingBlockBatchSize", "", "", &config.Configuration.Polygon.ProcessingBlockBatchSize},
