...
func NewEthDKGState(account accounts.Account) *EthDKGState {
	return &EthDKGState{Account: account}
}

func (state *EthDKGState) PopulateSchedule(event *bindings.ETHDKGRegistrationOpen) {
